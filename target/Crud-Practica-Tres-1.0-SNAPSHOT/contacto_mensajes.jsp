<%-- 
    Document   : contacto_mensajes
    Created on : 13/03/2024, 10:09:15 p. m.
    Author     : evo_l
--%>
        ...
        <div class="row">
            <div class="col-sm">
                <table class="table table-dark">
                    <thead>
                    <th scope="col" colspan="6">Mensajes de la lista de Contactanos</th>
                    <%-- <th scope="col"><a href="crear.jsp"><i class="fa fa-user-plus" aria-hidden="true"></i></a></th>--%>
                        ...
                        try {
                            ...
                            rs = st.executeQuery("SELECT * FROM mensajescontacto;");
                            while (rs.next()) {
                        %>
                                <tr>
